...
//        sQliteManager.addJob("movie3.mp4", "127.0.0.3", LocalDateTime.now().toString());
        ...
        String passwordToCheck = "superSecret123";  // This could come from user input in a real scenario
        boolean isPasswordCorrect = sQliteManager.verifyClientPassword("127.0.0.1", passwordToCheck);

        System.out.println("Password verification for 127.0.0.1: " + (isPasswordCorrect ? "SUCCESS" : "FAILED"));
